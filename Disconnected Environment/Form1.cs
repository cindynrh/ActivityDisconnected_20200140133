...
namespace Disconnected_Environment
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            chDesignation.Enabled = false;
            chDepartment.Enabled = false;

            chDesignation.Items.Add("MANAGER");
            chDesignation.Items.Add("AUTHOR");
            chDesignation.Items.Add("DESIGNER");

            chDepartment.Items.Add("MARKETING");
            chDepartment.Items.Add("FINANCE");
            chDepartment.Items.Add("IDD");
        ...
        private void cmdAdd_Click(object sender, EventArgs e)
        {
            ...
            chDesignation.Enabled = true;
            chDepartment.Enabled = true;
        ...
        private void cmdSave_Click(object sender, EventArgs e)
        {
            ...
            dr[5] = chDesignation.Text;
            dr[6] = chDepartment.Text;
            dt.Rows.Add(dr);
